...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ asset('https://amikom.ac.id/public/docs/2016/logo_amikom_full_color.png') }}">
  <title>AmikomScholl - {{ $title ?? '' }}</title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; {{ date('Y') }} Luthfi Adam S.</strong>
    All rights reserved.

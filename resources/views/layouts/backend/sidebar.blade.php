...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="/" class="brand-link">
    <img src="{{ asset('https://amikom.ac.id/public/docs/2016/logo_amikom_full_color.png') }}" alt="amikom Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
    <span class="brand-text font-weight-light">AmikomSchool</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ asset('img/icons') }}/luthfi.png" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
